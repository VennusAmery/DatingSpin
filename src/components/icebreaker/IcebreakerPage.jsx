...
const CATS = [
  ...
  { id:'treinta6', name:'36 Preguntas', emoji:'❓', color:'#A8D8EA' },
];
...
export default function IcebreakerPage() {
  ...
  const [custom, setCustom] = useLocalStorage('spindocky-icebreakers', {
  divertidas:[], profundas:[], romanticas:[], retos:[], treinta6:[]
});
    ...
    <>
      <div style={{ height:'100%', display:'flex', flexDirection:'column', gap:12 }}>
        ...
        <div className="card-ink" style={{ padding:'14px 18px', flexShrink:0, display:'flex', justifyContent:'space-between', alignItems:'center' }}>
          <div>
            <div style={{ fontFamily:'Fredoka One', fontSize:20, color:C.ink }}>💬 Rompiendo el hielo </div>
